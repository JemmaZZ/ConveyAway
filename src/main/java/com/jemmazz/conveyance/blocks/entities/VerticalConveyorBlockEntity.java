...
public class VerticalConveyorBlockEntity extends ConveyorBlockEntity
{
    ...
    {
        super( ConveyanceBlockEntities.VERTICAL_CONVEYOR, blockPos, blockState );
    }
    ...
    public void tick( World world, BlockPos pos, BlockState state )
    {
        ...
        {
            if( nextConveyor.isEmpty() || nextConveyor.getSpeed() == getSpeed() && nextConveyor.getVerticalPosition() > 0 && nextConveyor.getVerticalPosition() > getSpeed() / 4 )
            {
        ...
        else if( !isEmpty() && getCachedState().get( Conveyor.FRONT ) && world.getBlockEntity( pos.offset( facing ) ) instanceof ConveyorBlockEntity nextConveyor )
        {
