...
public class FunnelBlockEntity extends ConveyorBlockEntity
{
    ...
    {
        super( ConveyanceBlockEntities.FUNNEL, blockPos, blockState );
    }
    ...
    public void tick( World world, BlockPos pos, BlockState state )
    {
        ...
        {
            if( nextFunnel.isEmpty() || nextFunnel.getSpeed() == getSpeed() && nextFunnel.getPosition() > 0 && nextFunnel.getPosition() > getSpeed() / 4 )
            {
